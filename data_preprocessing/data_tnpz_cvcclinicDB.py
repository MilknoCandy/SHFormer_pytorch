...
❤LastEditTime: 2023-12-16 20:45:44
...
if __name__ == '__main__':
    img_pth = '/root/autodl-tmp/CVC-ClinicDB/Original'
    lab_pth = '/root/autodl-tmp/CVC-ClinicDB/Ground Truth'

    target_base = '/root/autodl-tmp/CVC-ClinicDB'
    ...
    training_cases = subfiles(lab_pth, suffix='.tif', join=False)
    ...
    for tr in training_cases:
        ...
        input_img_file = join(img_pth, case_id+'.tif')
