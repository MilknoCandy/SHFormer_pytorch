...
class Mlp(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        self.fe = Feature_Enhance(in_dim=in_features)      # 额外的特征增强
        ...
        if sr_ratio > 1:
            ...
            if sr_ratio==8:
                ...
                self.sr = nn.Sequential(
                    ...
                    # Conv(dim, dim//4, kernel_size=sr_ratio//4, stride=sr_ratio//4, bn=True, relu=True, padding=0, groups=4),
                ...
                self.sr = nn.Sequential(
                    ...
                    # Conv(dim, dim//2, kernel_size=sr_ratio//2, stride=sr_ratio//2, bn=True, relu=True, padding=0, groups=2),
