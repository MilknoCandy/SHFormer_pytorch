...
❤LastEditTime: 2023-03-17 10:04:34
...
from network_architecture.shformer.block_compare.SE_block import SE_Block
...
class Mlp(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        self.fe = SE_Block(channel=out_features)      # 额外的特征增强
