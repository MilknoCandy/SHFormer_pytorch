...
❤LastEditTime: 2023-12-16 21:10:02
...
from ..decode_head_type import decode_head_PLD
from ..mix_transformer import mit_b0


class shformer_add_PLD(nn.Module):
    def __init__(self, in_chans=3, num_classes=1, embed_dims=[32, 64, 160, 256], heads=[1, 2, 5, 8], linear_bias=True, mlp_ratio=4.,
        ...
        #               Decoder
        ###################################################
        self.decode_heade = decode_head_PLD(dims=embed_dims, dim=128, class_num=num_classes)
