...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels=1, n_classes=2, feature_scale=1, is_deconv=True, is_batchnorm=True, is_fe=False):
        ...
        # featuer enhance
        self.fe = Feature_Enhance(in_dim=filters[0]) if is_fe else None
...
if __name__ == '__main__':
    ...
    print(f"| model |macs:', {macs/1e9}, 'params:', {params/1e6}|")
