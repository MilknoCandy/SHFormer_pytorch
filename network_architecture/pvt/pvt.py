...
❤version: 1.0
❤Author: MilknoCandy
❤Date: 2023-11-27 10:24:54
❤LastEditTime: 2023-11-28 09:25:15
❤FilePath: pvt
...
class pvt_single(PyramidVisionTransformer):
    def __init__(self, **kwargs):
        super(pvt_single, self).__init__(
            patch_size=4, embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[1, 1, 1, 1],
